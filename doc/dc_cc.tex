...
\marginpar{Introduce \emph{Dynamic DCCC}}
\end{enumerate}
...
\marginpar{Can you specify \emph{somewhat complex}?}
...
\marginpar{Add a figure showing the setup of the machines, IP addresses switch here}
...
\marginpar{Introduce \emph{SUP} and \emph{DBL}}
...
\marginpar{I don't understand this}
...
\marginpar{Add reference to the figure I suggested}
...
The keyword \textt{sends} indicates how many bytes to send. We always elected 1448 since this is
...
net structures.
\marginpar{Explain stcb and net structure}
...
\marginpar{Provide units on the y-axis}
...
\marginpar{What is shown on the y-axis? Don't provide only the unit}
