...
SDT_PROBE_ARGTYPE(sctp, cwnd, net, val, val, 0, "uint32_t");
...
/* The Vtag for this end */
SDT_PROBE_ARGTYPE(sctp, rwnd, assoc, val, val, 0, "uint32_t");
/* The port number of the local side << 16 | port number of remote 
 * in network byte order.
 */
SDT_PROBE_ARGTYPE(sctp, rwnd, assoc, val, val, 1, "uint32_t");
/* The up/down amount */
SDT_PROBE_ARGTYPE(sctp, rwnd, assoc, val, val, 2, "int");
/* The new value of the cwnd */
SDT_PROBE_ARGTYPE(sctp, rwnd, assoc, val, val, 3, "int");
...
/* The Vtag for this end */
SDT_PROBE_ARGTYPE(sctp, flightsize, net, val, val, 0, "uint32_t");
/* The port number of the local side << 16 | port number of remote 
 * in network byte order.
 */
SDT_PROBE_ARGTYPE(sctp, flightsize, net, val, val, 1, "uint32_t");
/* The pointer to the struct sctp_nets * changing */
SDT_PROBE_ARGTYPE(sctp, flightsize, net, val, val, 2, "uintptr_t");
/* The up/down amount */
SDT_PROBE_ARGTYPE(sctp, flightsize, net, val, val, 3, "int");
/* The new value of the cwnd */
SDT_PROBE_ARGTYPE(sctp, flightsize, net, val, val, 4, "int");
/********************************************************/
/* The total flight version */
/********************************************************/
SDT_PROBE_DEFINE(sctp, flightsize, assoc, val, val);
/* The Vtag for this end */
SDT_PROBE_ARGTYPE(sctp, flightsize, assoc, val, val, 0, "uint32_t");
/* The port number of the local side << 16 | port number of remote 
 * in network byte order.
 */
SDT_PROBE_ARGTYPE(sctp, flightsize, net, assoc, val, 1, "uint32_t");
/* The up/down amount */
SDT_PROBE_ARGTYPE(sctp, flightsize, net, assoc, val, 2, "int");
/* The new value of the cwnd */
SDT_PROBE_ARGTYPE(sctp, flightsize, net, assoc, val, 3, "int");
