...
if [ `id -g` = "0" ]
then
	export LONGVER="4.1.0 built on `date`"
	...
	chmod 755	MacOS_Installer/Files/System/Library/Extensions/SCTP.kext/Contents
	...
	chmod 644	MacOS_Installer/Files/System/Library/Extensions/SCTP.kext/Contents/Resources/English.lproj
...
StartService ()
{
	...
	sed	"s/UNAME_MINUS_R_HERE/\`uname -r\`/g" < /System/Library/Extensions/SCTP.kext/Contents/Info.plist.template >/System/Library/Extensions/SCTP.kext/Contents/Info.plist
	chmod 644			 /System/Library/Extensions/SCTP.kext/Contents/Info.plist
	kextload -t -v /System/Library/Extensions/SCTP.kext
}
...
--EOF--
	...
	/Developer/Tools/packagemaker -build -p SCTP.pkg -proj SCTP.pmproj
