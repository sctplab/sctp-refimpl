...
ifeq ($(OSTYPE),FreeBSD)
CFLAGS  = -g $(MYGPROF) -DSCTP_USERMODE -U__FreeBSD__ -U__APPLE__ -U__Panda__ -U__Windows__ -D__Userspace__ -D__Userspace_os_$(OSTYPE) -Wall -march=$(ARCHTYPE)
else
CFLAGS  = -g $(MYGPROF) -DSCTP_USERMODE -U__FreeBSD__ -U__APPLE__ -U__Panda__ -U__Windows__ -D__Userspace__ -D__Userspace_os_$(OSTYPE) -Wall
endif
...
LIBS =  -lm -lumem -luserspace -lcrypto -lpthread 
