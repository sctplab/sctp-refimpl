...
SDT_PROBE_DECLARE(sctp, cwnd, net, val, val);

/* One to track an associations rwnd */
SDT_PROBE_DECLARE(sctp, rwnd, assoc, val, val);

/* One to track a net's flight size */ 
SDT_PROBE_DECLARE(sctp, flightsize, net, val, val);

/* One to track an associations flight size */ 
SDT_PROBE_DECLARE(sctp, flightsize, assoc, val, val);
