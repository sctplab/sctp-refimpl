...
ifeq ($(OSTYPE),FreeBSD)
CFLAGS  = -g -DSCTP_USERMODE -U__FreeBSD__ -U__APPLE__ -U__Panda__ -U__Windows__ -D__Userspace__ -D__Userspace_os_$(OSTYPE) -Wall -march=$(ARCHTYPE)
else
CFLAGS  = -g -DSCTP_USERMODE -U__FreeBSD__ -U__APPLE__ -U__Panda__ -U__Windows__ -D__Userspace__ -D__Userspace_os_$(OSTYPE) -Wall
endif
